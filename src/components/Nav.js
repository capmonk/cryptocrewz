...
export default function Nav() {
  ...
  // }
	return (
		<>
			<div className='sticky top-0 z-40 flex-row justify-between w-full p-5 lg:flex pointer-events-none'>
			...
			{/* <div className='fixed z-[99] flex flex-row justify-between w-screen p-2 lg:hidden'>
				...
				<div className='flex flex-col items-center'>
					<div className='flex flex-row pt-3 mb-3 items-center'>
						<a
			...
			{/* {isOpen && (
				<>
					<div
						onClick={closeNav}
						className='fixed top-0 left-0 backdrop-filter backdrop-blur-sm z-[98]'
					></div>
